            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-md-12 order-md-1 text-center">
                        <h4 className="h3 mb-3 fw-normal">Crear Nota</h4>
                        <form className="form-signin needs-validation" onSubmit={handleOnSubmit} noValidate>
                            <div className="row">
                                <div className="col-md-12 mb-3 form-floating">
                                    <input type="text" className="form-control" id="title" name="title" placeholder="" defaultValue="" autoComplete="current-password" required />
                            ...
                            <div className="row">
                                <div className="col-md-12 mb-3">
                                    ...
                                    <textarea className="form-control" id="content" name="content" placeholder="" defaultValue="" required rows="8"></textarea>
                                    <div className="invalid-feedback">
                                        content is required.
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                <div className="col-md-12 mb-3">
                                    ...
                                    <select className="form-select d-block w-100" id="category" name="category" defaultValue="important" aria-label="Default select example" required>
                            ...
                            <hr className="mb-4" />
                            <Boton loading={state.loading} title={'Crear'} type={"submit"} ></Boton>
                        </form>
                    </div>
                </div>
            </div>
